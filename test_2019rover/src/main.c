...
void shut()
{
	...
	GPIO_ResetBits(GPIOE,GPIO_Pin_15|GPIO_Pin_13 | GPIO_Pin_12 | GPIO_Pin_10|GPIO_Pin_11 | GPIO_Pin_8);
	GPIO_ResetBits(GPIOA,GPIO_Pin_11 | GPIO_Pin_10 | GPIO_Pin_8 | GPIO_Pin_7 | GPIO_Pin_6 | GPIO_Pin_5 | GPIO_Pin_4 | GPIO_Pin_3 | GPIO_Pin_0);
	GPIO_ResetBits(GPIOB,GPIO_Pin_1 | GPIO_Pin_3 | GPIO_Pin_5 | GPIO_Pin_8);
	GPIO_ResetBits(GPIOD,GPIO_Pin_5|GPIO_Pin_2);
...
{//linear act 2<==>swivel base
	...
	if(link=='A')
				...
				GPIO_SetBits(GPIOD,GPIO_Pin_2); // gripper //later pd2 ko pd8 se replace karo
				GPIO_SetBits(GPIOD,GPIO_Pin_5);
				}
			else if(link=='B')
				{
					GPIO_SetBits(GPIOD,GPIO_Pin_2); //  gripper
					GPIO_ResetBits(GPIOD,GPIO_Pin_5);
				}
			else if(link=='C')
				{ GPIO_SetBits(GPIOA,GPIO_Pin_4); //linear act 1
				...
				{
				GPIO_SetBits(GPIOA,GPIO_Pin_6);     ///link 2
