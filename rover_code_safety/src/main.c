...
void gpioinit()
{
	...
	GPIO_ResetBits(GPIOE,GPIO_Pin_13 |GPIO_Pin_15|GPIO_Pin_14| GPIO_Pin_12 | GPIO_Pin_10 |GPIO_Pin_11 | GPIO_Pin_8);
...
void gpioinit1()
{
	...
	GPIO_InitTypeDef GPIO_InitStruct;
	GPIO_InitStruct.GPIO_Pin = GPIO_Pin_12 | GPIO_Pin_10 | GPIO_Pin_9 | GPIO_Pin_8 | GPIO_Pin_7 | GPIO_Pin_6 | GPIO_Pin_5 | GPIO_Pin_4 | GPIO_Pin_3 | GPIO_Pin_2 | GPIO_Pin_1 | GPIO_Pin_0;
	GPIO_InitStruct.GPIO_Mode = GPIO_Mode_OUT;
	GPIO_InitStruct.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_InitStruct.GPIO_OType = GPIO_OType_PP;
	GPIO_InitStruct.GPIO_PuPd = GPIO_PuPd_UP;
...
void shut()
{
	...
	GPIO_ResetBits(GPIOE,GPIO_Pin_13 |GPIO_Pin_15|GPIO_Pin_14| GPIO_Pin_12 | GPIO_Pin_10|GPIO_Pin_11 | GPIO_Pin_8);
	GPIO_ResetBits(GPIOA,GPIO_Pin_12 | GPIO_Pin_10 | GPIO_Pin_9 | GPIO_Pin_8 | GPIO_Pin_7 | GPIO_Pin_6 | GPIO_Pin_5 | GPIO_Pin_4 | GPIO_Pin_3 | GPIO_Pin_2 | GPIO_Pin_1 | GPIO_Pin_0);
	TIM_SetCompare1(TIM1, 0);
	TIM_SetCompare2(TIM1, 0);
	TIM_SetCompare1(TIM3, 0);
	TIM_SetCompare2(TIM3, 0);
...
void armcode(char link)
{
	if(link=='A')
		...
		GPIO_SetBits(GPIOA,GPIO_Pin_0); // swivel base close
					GPIO_SetBits(GPIOA,GPIO_Pin_1);
		}
	else if(link=='B')
		{
			GPIO_SetBits(GPIOA,GPIO_Pin_0); // swivel base open
